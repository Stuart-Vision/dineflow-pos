...
>(({ className, children, size = 'default', showCloseButton = true, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        'fixed top-1/2 left-1/2 z-50 grid w-[calc(100vw-2rem)] -translate-x-1/2 -translate-y-1/2',
        'max-h-[calc(100dvh-2rem)] gap-4 overflow-y-auto rounded-xl border border-border',
        'bg-card p-6 shadow-overlay duration-200 scrollbar-slim',

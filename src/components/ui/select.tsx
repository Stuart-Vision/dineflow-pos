...
>(({ className, children, size = 'default', invalid, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    aria-invalid={invalid || undefined}
    className={cn(
      'flex w-full items-center justify-between gap-2 rounded-md border border-input bg-card px-3 py-1',
      'text-sm shadow-xs transition-[color,box-shadow,border-color] outline-none',
